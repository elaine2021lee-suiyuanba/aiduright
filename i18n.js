...
const I18N = {
  ...
  ui: {
    en: {
      ...
      askAi: 'Need help? Ask Aidu',
      aiTitle: 'Ask Aidu about this question',
      aiClose: 'Close chat',
      aiPrivacy: 'Your questions and photos go to Aidu, our AI assistant. Cover your Social Security number and account numbers before you send a photo.',
      aiIntro: "Hi, I'm Aidu! Ask me anything about this question — what a word means, what counts, or which documents you'll need. You can also send a photo of a letter or form and I'll read it with you.",
      aiPlaceholder: 'Type your question…',
      aiSend: 'Send',
      aiPhoto: 'Add a photo',
      aiCamera: 'Take a photo',
      aiRemovePhoto: 'Remove this photo',
      aiPhotoAlt: 'Photo you sent',
      aiPhotoReminder: 'Before you send: cover your Social Security number, account numbers, and anything else you would not read out loud.',
      aiThinking: 'Thinking…',
      aiDisclaimer: 'Aidu is an AI and can be wrong. Always confirm with the official program or call 211.',
      aiErrorPhotoType: "I can't read that kind of file. Send a photo or screenshot instead (JPG, PNG, GIF, or WebP).",
      aiErrorPhotoTooLarge: 'That photo is too big to send. Try taking it again, or crop it to just the part you have a question about.',
      aiErrorPhotoCount: 'You can send up to two photos at a time.',
      aiErrorPhotoRead: "I couldn't open that photo. Try a different one.",
    ...
    es: {
      ...
      askAi: '¿Necesitas ayuda? Pregunta a Aidu',
      aiTitle: 'Pregunta a Aidu sobre esta pregunta',
      aiClose: 'Cerrar el chat',
      aiPrivacy: 'Tus preguntas y fotos se envían a Aidu, nuestro asistente de IA. Tapa tu número de Seguro Social y los números de cuenta antes de enviar una foto.',
      aiIntro: '¡Hola, soy Aidu! Pregúntame lo que quieras sobre esta pregunta: qué significa una palabra, qué cuenta o qué documentos vas a necesitar. También puedes enviarme una foto de una carta o un formulario y la leemos juntos.',
      aiPlaceholder: 'Escribe tu pregunta…',
      aiSend: 'Enviar',
      aiPhoto: 'Agregar una foto',
      aiCamera: 'Tomar una foto',
      aiRemovePhoto: 'Quitar esta foto',
      aiPhotoAlt: 'Foto que enviaste',
      aiPhotoReminder: 'Antes de enviar: tapa tu número de Seguro Social, los números de cuenta y cualquier dato que no dirías en voz alta.',
      aiThinking: 'Pensando…',
      aiDisclaimer: 'Aidu es una IA y puede equivocarse. Confirma siempre con el programa oficial o llama al 211.',
      aiErrorPhotoType: 'No puedo leer ese tipo de archivo. Envía una foto o una captura de pantalla (JPG, PNG, GIF o WebP).',
      aiErrorPhotoTooLarge: 'Esa foto es demasiado grande. Tómala de nuevo o recórtala para dejar solo la parte sobre la que preguntas.',
      aiErrorPhotoCount: 'Puedes enviar hasta dos fotos a la vez.',
      aiErrorPhotoRead: 'No pude abrir esa foto. Intenta con otra.',
    ...
    zh: {
      ...
      docsNone: '无需材料即可开始。',
      askAi: '需要帮助?问 Aidu',
      aiTitle: '就这个问题询问 Aidu',
      aiClose: '关闭对话',
      aiPrivacy: '你的问题和照片会发送给我们的 AI 助手 Aidu。拍照前请遮住社会安全号码和账号。',
      aiIntro: '你好,我是 Aidu!关于这个问题,你可以问我任何事 —— 某个词是什么意思、哪些情况算在内,或者你需要准备哪些材料。你也可以拍一张信件或表格的照片发给我,我陪你一起看。',
      aiPlaceholder: '输入你的问题…',
      aiSend: '发送',
      aiPhoto: '添加照片',
      aiCamera: '拍照',
      aiRemovePhoto: '移除这张照片',
      aiPhotoAlt: '你发送的照片',
      aiPhotoReminder: '发送前请先遮住:社会安全号码、账号,以及任何你不会念出声的信息。',
      aiThinking: '正在思考…',
      aiDisclaimer: 'Aidu 是 AI,回答可能有误。请务必向官方项目确认,或致电 211。',
      aiErrorPhotoType: '这种文件我读不了。请发送照片或截图(JPG、PNG、GIF 或 WebP)。',
      aiErrorPhotoTooLarge: '这张照片太大了。可以重拍一张,或者只裁剪出你想问的那部分。',
      aiErrorPhotoCount: '一次最多可以发送两张照片。',
      aiErrorPhotoRead: '这张照片打不开。换一张试试。',
